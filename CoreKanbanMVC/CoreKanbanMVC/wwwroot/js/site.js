function hideElements() {
    ...
    let elements2 = document.querySelectorAll(".always-hidden");
...
function submitFormBoard() {
    ...
    let form = document.querySelector(".board-name-h form.update-board");
...
function submitFormDeleteBoard() {

    let form = document.querySelector(".board-name-h form.delete-board");
...
function submitFormColumn(columnId) {
    ...
    let column = document.querySelector(".column-" + columnId);
    let form = column.querySelector(".column-name form.update-column");
    let input = form.querySelector("input");
...
function submitFormDeleteColumn(columnId) {

    let column = document.querySelector(".column-" + columnId);
    let form = column.querySelector(".column-name form.delete-column");
...
function submitFormNote(noteId) {
    ...
    let note = document.querySelector(".note-" + noteId);
    let form = note.querySelector("form.update-note");
    let input = form.querySelector("input");
    let textarea = form.querySelector("textarea");
...
function submitFormDeleteNote(noteId) {

    let note = document.querySelector(".note-" + noteId);
    let form = note.querySelector("form.delete-note");
